...
function MainContent() {
  ...
  useEffect(() => {
    if (user) {
      ...
      const forbiddenTabs = ['catalog','suppliers','customers','purchases','stocks','transfers','cash-sessions','sales','pos','reports','settings']
  ...
  const navLinks = [
    ...
    { tab: 'branches',      icon: 'fa-store',           label: 'Boutiques',     show: !!(user && isAdmin) },
