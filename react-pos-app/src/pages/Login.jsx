...
export const Login = ({ setActiveTab }) => {
  ...
  const handleStandardSubmit = async (e) => {
    ...
    // Vider les anciens en-têtes tenant résiduels avant toute tentative
  ...
  // Soumission connexion GitHub OAuth
  const handleGitHubLogin = async () => {
    ...
    try {
      ...
      if (response.data?.url) {
        ...
        setError("Impossible d'initialiser l'authentification GitHub.");
      }
    } catch (err) {
      setError(err.response?.data?.error || err.response?.data?.message || "Erreur de connexion GitHub.");
    } finally {
      setLoading(false);
    }
  };
